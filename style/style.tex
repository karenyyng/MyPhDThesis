...
% Use package float to control the location where figure appears 
\usepackage{float}
...
\usepackage[linktocpage,bookmarksnumbered,% For PDF navigation
						...
						pdftitle={PhD Dissertation, Karen Y. Ng}, % Insert your title
						pdfauthor={Karen Y. Ng}, % Insert your name
						pdfsubject={UC Davis Ph.D. Doctoral Dissertation},%
						pdfkeywords={UC Davis Ph.D. Doctoral Dissertation}]{hyperref}
\usepackage{breakurl}
...
%%% GP notations
\newcommand{\covgp}{\mathsf{C}}
\newcommand{\kerngp}{\mathsf{K}}
\newcommand{\rhogp}{\rho_{\rm GP}}
\newcommand{\lambdagp}{\lambda_{\rm GP}}
\newcommand{\gpparams}{a_{\rm GP}}
\newcommand{\lensparams}{\Upsilon}
...
% ---------- End of Karen Ng 's customization --------------
