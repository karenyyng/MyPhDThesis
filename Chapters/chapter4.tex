...
This is because the multiplication of Gaussian distributions result in another
...
component that are independent and identically distributed (i.i.d), 
we have to model that as well using a diagonal noise kernel. 
...
shown in Section \ref{subsubsec:interpolation}.
For predicting lensing observables, our data vector is a concatenation of the
...
conditional distribution follows eq. \ref{eq:conditional_distribution}.
