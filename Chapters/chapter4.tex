...
% which part of the complicated cosmic shear inference do we address?
...
of uncertainties. 
% This procedure involves many steps and a statistical approach is needed to
% extract the signal from many background galaxy tracers. 
 


We focus our analysis on the linear part of the large scale 
