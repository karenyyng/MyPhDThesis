...
\begin{align}
	...
	% &\sim \frac{1}{\sqrt{2\pi |\kerngp(\xv_{\mathds{1}}, \yv_{\mathds{1}};\gpparams)|}}
	% \exp\left( \psi_0^T \kerngp(\xv_{\mathds{1}}, \yv_{\mathds{1}};\gpparams) \psi_0 \right)\label{eq:GP}
\end{align}
...
The joint probability density function for the (mean-subtracted) data of a GP is:
\begin{equation}
